...
in a terminal.
On Windows, the DLLs are bundled with the executable. Extremely fucking stupid decision from Qt and GNU developers because I should be able to just have it in one executable, but NOOOOO, we have to do the stupidest things in the programming industry.
